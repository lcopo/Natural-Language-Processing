...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    simp_rnn = GRU(units, activation='relu', return_sequences=True, implementation=2, name='rnn_' + '0')(input_data)
    bn_rnn = BatchNormalization(name='bn_simp_rnn_' + '0')(simp_rnn)
    
    for i in range(1, recur_layers):
        simp_rnn = GRU(units, activation='relu', return_sequences=True, implementation=2, name='rnn_'+ str(i))(simp_rnn)
        bn_rnn = BatchNormalization(name='bn_simp_rnn_' + str(i))(simp_rnn)
